...
print("length of birthdate_template:", len(birth_date_template))
...
print("length of birthplace_template:", len(birth_place_template))
...
print("length of university_template:", len(university_template))
...
print("length of major_template:", len(major_template))
...
print("length of company_template:", len(company_template))
...
print("length of location_template:", len(location_template))

for template in [birth_date_template, birth_place_template, university_template, major_template, company_template, location_template]:
    for i, t in enumerate(template):
        # if [X] is before [Y], print message
        if t.index("[X]") > t.index("[Y]"):
            print(f"Template {i} is incorrect format: {t}")

# save dict json

templates_dict = {
    "birth_date_template": birth_date_template,
    "birth_place_template": birth_place_template,
    "university_template": university_template,
    "major_template": major_template,
    "company_template": company_template,
    "location_template": location_template
}

with open("bio_templates.json", "w", encoding="utf8") as f:
